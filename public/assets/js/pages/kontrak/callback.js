...
// ===== MATERIAL =====
function callbackkontrakChange({data}) {
    console.log(data)
    $('#nomorKontrak').text(data.nomor_kontrak);
    $('#namaPelaksana').text(data.pelaksana);
...
function amandemenModalOpenCallback() {
    $('#amandemenModal').modal('show');
}

// ===== AMANDEMEN =====
function amandemenSaveCallback(data) {
    location.reload();
}