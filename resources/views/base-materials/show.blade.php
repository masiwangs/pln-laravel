                    ...
                    <div class="row">
                        <form id="prkForm" class="col-12 col-md-6 col-lg-5 col-xl-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="first-name-vertical" class="form-control prk-field" name="nama" value="{{ $prk->nama }}" placeholder="Masukkan nama project">
                            </div>
                            <div class="form-group mb-3">
                                <label for="first-name-vertical">Nomor PRK</label>
                                <input type="text" id="first-name-vertical" class="form-control prk-field" name="prk" value="{{ $prk->prk }}" placeholder="Masukkan nomor PRK">
                            </div>
                            <div class="form-group mb-3">
                                <label for="first-name-vertical">Lot</label>
                                <input type="text" id="first-name-vertical" class="form-control prk-field" name="lot" value="{{ $prk->lot }}" placeholder="Masukkan lot">
                            </div>
                            <div class="form-group mb-3">
                                <label for="first-name-vertical">Prioritas</label>
                                <input type="text" id="first-name-vertical" class="form-control prk-field" name="prioritas" value="{{ $prk->prioritas }}" placeholder="Masukkan prioritas">
                            </div>
                        </form>
                    </div>
                </div>
